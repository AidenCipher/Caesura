  ...
  return (
    <>
      ...
      <section className="w-full max-w-4xl pb-16 text-center sm:mx-auto sm:text-left">
        ...
        <h2 className="mt-8 text-balance text-3xl font-semibold leading-tight text-sky-50 sm:text-4xl lg:text-5xl">
          It&apos;s almost time to celebrate everything you&apos;ve built, shared,
          and become.
        </h2>

        <p className="mt-6 max-w-2xl text-balance text-base leading-relaxed text-sky-100/80 sm:text-lg">
        ...
        <p className="mt-4 max-w-xl text-sm text-sky-100/70 sm:text-base">
